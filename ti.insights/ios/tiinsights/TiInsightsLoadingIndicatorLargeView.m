...
#import "TiInsightsLoadingIndicatorLargeView.h"

@implementation TiInsightsLoadingIndicatorLargeView
...
- (void)bakeLayout
{
    [rightCircle setFrame:CGRectMake(self.bounds.size.width / 2, self.bounds.size.height / 2, 688, 688)];
    [leftCircle setFrame:CGRectMake(self.bounds.size.width / 2, self.bounds.size.height / 2, 688, 688)];
...
- (id)init
{
    if (self = [super init])
    {
        ...
        [rightCirclePath addArcWithCenter:CGPointMake(self.bounds.size.width / 2, self.bounds.size.height / 2) radius:344 startAngle:degreesToRadians(225) endAngle:degreesToRadians(45) clockwise:YES];
        
        [leftCirclePath addArcWithCenter:CGPointMake(self.bounds.size.width / 2, self.bounds.size.height / 2) radius:344 startAngle:degreesToRadians(45) endAngle:degreesToRadians(225) clockwise:YES];
