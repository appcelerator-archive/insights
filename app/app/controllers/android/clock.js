...
function scale() {
    lib.scaler.sp($.parentContainer, { width:200, height:35 });
    
    lib.scaler.sp($.lightTimeContainer, { top:3 });
    lib.scaler.sp($.dateLightLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.lightPipe, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeHourLightLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeDivLight01Lbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeMinuteLightLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeDivLight02Lbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeSecondLightLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeFormatLightLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.lightSpacer01, { width:5 });
    lib.scaler.sp($.lightSpacer02, { width:6 });
    lib.scaler.sp($.lightSpacer03, { width:5 });
    lib.scaler.sp($.lightSpacer04, { width:6 });
    lib.scaler.sp($.lightSpacer05, { width:5 });
    lib.scaler.sp($.lightSpacer06, { width:6 });
    lib.scaler.sp($.lightSpacer07, { width:5 });

    lib.scaler.sp($.darkTimeContainer, { top:3 });
    lib.scaler.sp($.dateDarkLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.darkPipe, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeHourDarkLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeDivDark01Lbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeMinuteDarkLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeDivDark02Lbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeSecondDarkLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.timeFormatDarkLbl, { font:{ fontSize:12 } });
    lib.scaler.sp($.darkSpacer01, { width:5 });
    lib.scaler.sp($.darkSpacer02, { width:6 });
    lib.scaler.sp($.darkSpacer03, { width:5 });
    lib.scaler.sp($.darkSpacer04, { width:6 });
    lib.scaler.sp($.darkSpacer05, { width:5 });
    lib.scaler.sp($.darkSpacer06, { width:6 });
    lib.scaler.sp($.darkSpacer07, { width:5 });
}
