...
function createMetricElement(count, spacer, offset, index, funnel) {
    ...
    var _directionBgBase = (funnel) ? null : (_metric.direction === 0) ? '/images/detail/metric-trend-arrow-none' : (_metric.direction === -1) ? '/images/detail/metric-trend-arrow-down' : '/images/detail/metric-trend-arrow-up';
    ...
    var _container = Ti.UI.createView({ left:0, opacity:0.0, width:Ti.UI.SIZE, height:lib.scaler.sv(100, false), top:offset, touchEnabled:false }),
        _spacer = null;

    var _metricContainer        = Ti.UI.createView({ opacity:(_isDefault) ? 0.0 : 1.0, width:Ti.UI.SIZE, height:lib.scaler.sv(100, false), top:0, touchEnabled:false }),
        _titleContainer         = Ti.UI.createView({ touchEnabled:false /* #BUG */, top:0, height:lib.scaler.sv(18, false), width:Ti.UI.SIZE, layout:"horizontal" }),
        _typeIcon               = null,
        _typeSpacer             = Ti.UI.createView({ touchEnabled:false /* #BUG */, width:lib.scaler.sv(8, true) }),
        _nameLbl                = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, top:0, width:Ti.UI.SIZE, height:lib.scaler.sv(18, false), color:'#4c4c4c', font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) }, text:_metric.name }),
        _dividerLbl             = null, // this is only generated for funnels
        _descLbl                = null, // this is only generated for funnels
        _totalLbl               = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, width:Ti.UI.SIZE, height:lib.scaler.sv(52, false), color:'#4c4c4c', font:{ fontFamily: "TitilliumText22L-1wt", fontSize:lib.scaler.sv(50, false) } }),
        _rangeAndTrendContainer = Ti.UI.createView({ touchEnabled:false /* #BUG */, height:lib.scaler.sv(16, false), bottom:0 }),
        _rangeLbl               = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, width:lib.scaler.sv(112, true), height:lib.scaler.sv(16, false), color:'#4c4c4c', font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) }, text:_metric.range[_metricElement.state.currentRange].name }),
        _trendIconView          = Ti.UI.createView({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, right:lib.scaler.sv(30, true), width:lib.scaler.sv(9, true), height:lib.scaler.sv(10, false), top:lib.scaler.sv(2, false), backgroundImage:_directionBgBase + '-inactive.png' }),
        _trendLbl               = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, right:0, width:lib.scaler.sv(26, true), height:lib.scaler.sv(16, false), color:'#4c4c4c', font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) }, text:'24h' });

    var _metricFocusContainer        = Ti.UI.createView({ touchEnabled:false /* #BUG */, opacity:(_isDefault) ? 1.0 : 0.0, width:Ti.UI.SIZE, height:lib.scaler.sv(100, false), top:0, touchEnabled:false }),
        _titleFocusContainer         = Ti.UI.createView({ touchEnabled:false /* #BUG */, top:0, height:lib.scaler.sv(18, false), width:Ti.UI.SIZE, layout:"horizontal" }),
        _typeFocusIcon               = Ti.UI.createView({ touchEnabled:false /* #BUG */, height:lib.scaler.sv(18, false), width:lib.scaler.sv(28, true) }), // icon is determined further down
        _typeFocusSpacer             = Ti.UI.createView({ touchEnabled:false /* #BUG */, width:lib.scaler.sv(8, true) }),
        _nameFocusLbl                = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, top:0, width:Ti.UI.SIZE, height:lib.scaler.sv(18, false), color:'#f2f2f2', font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) }, text:_metric.name }),
        _dividerFocusLbl             = null, // this is only generated for funnels
        _descFocusLbl                = null, // this is only generated for funnels
        _totalFocusLbl               = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, width:Ti.UI.SIZE, height:lib.scaler.sv(52, false), color:metrics.colors[state.selected.category].base, font:{ fontFamily: "TitilliumText22L-1wt", fontSize:lib.scaler.sv(50, false) } }),
        _rangeAndTrendFocusContainer = Ti.UI.createView({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, height:lib.scaler.sv(16, false), bottom:0 }),
        _rangeFocusLbl               = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, width:lib.scaler.sv(112, true), height:lib.scaler.sv(16, false), color:'#f2f2f2', font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) }, text:_metric.range[0].name }),
        _trendIconFocusView          = Ti.UI.createView({ touchEnabled:false /* #BUG */, right:lib.scaler.sv(30, true), width:lib.scaler.sv(9, true), height:lib.scaler.sv(10, false), top:lib.scaler.sv(2, false), backgroundImage:_directionBgBase + '.png' }),
        _trendFocusLbl               = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, right:0, width:lib.scaler.sv(26, true), height:lib.scaler.sv(16, false), color:'#f2f2f2', font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) }, text:'24h' });
    ...
    _metricElement.controllers = {
        ...
        focusNumber: function() {
            if (_metricElement.state.selected) {
                _totalFocusLbl.animate({ transform:Ti.UI.create2DMatrix({ scale:0.94 }), duration:100 }, function() {
                    _totalFocusLbl.animate({ transform:Ti.UI.create2DMatrix({ scale:1.0 }), duration:100 });
                });
            } else {
                _totalLbl.animate({ transform:Ti.UI.create2DMatrix({ scale:0.94 }), duration:100 }, function() {
    ...
    if (funnel) {
        _dividerLbl    = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, color:'#4c4c4c', text:'/', textAlign:'center', width:lib.scaler.sv(18, true), height:Ti.UI.FILL, font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) } }),
        _descLbl       = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, color:'#4c4c4c', text:'CR', width:Ti.UI.SIZE, height:Ti.UI.FILL, font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) } }),
        _typeIcon      = Ti.UI.createView({ touchEnabled:false /* #BUG */, height:lib.scaler.sv(18, false), width:lib.scaler.sv(15, true), backgroundImage:'/images/detail/metric-type-icon-funnel-inactive.png' }),
        _typeFocusIcon = Ti.UI.createView({ touchEnabled:false /* #BUG */, height:lib.scaler.sv(18, false), width:lib.scaler.sv(15, true), backgroundImage:'/images/detail/metric-type-icon-funnel.png' });

        _dividerFocusLbl = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, color:'#4c4c4c', text:'/', textAlign:'center', width:lib.scaler.sv(18, true), height:Ti.UI.FILL, font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) } }),
        _descFocusLbl = Ti.UI.createLabel({ touchEnabled:false /* #BUG */, includeFontPadding:false /* WORKAROUND */, color:'#f2f2f2', text:'CR', width:Ti.UI.SIZE, height:Ti.UI.FILL, font:{ fontFamily: "TitilliumText22L-250wt", fontSize:lib.scaler.sv(16, false) } }),

        _totalLbl.text = _totalFocusLbl.text = _metric.range[_metricElement.state.currentRange].total + '%';
        _rangeLbl.textAlign = _rangeFocusLbl.textAlign = 'center'; 
        _rangeAndTrendContainer.width = _rangeAndTrendFocusContainer.width = 112;
    } else {
        _typeIcon      = Ti.UI.createView({ touchEnabled:false /* #BUG */, height:lib.scaler.sv(18, false), width:lib.scaler.sv(28, true), backgroundImage:'/images/detail/metric-type-icon-standard-inactive.png' }),
        _typeFocusIcon = Ti.UI.createView({ touchEnabled:false /* #BUG */, height:lib.scaler.sv(18, false), width:lib.scaler.sv(28, true), backgroundImage:'/images/detail/metric-type-icon-standard.png' });

        _rangeLbl.left = _rangeFocusLbl.left = 0;
        _rangeAndTrendContainer.width = _rangeAndTrendFocusContainer.width = lib.scaler.sv(175, false);
    ...
    _metricElement.parentView = Ti.UI.createView({ top:0, index:count, type:_metric.type, funnelIndex:(funnel) ? index : null, id:(funnel) ? globalData.categories[state.selected.category].funnels[index].id : metrics.ordered[state.selected.category][index], width:Ti.UI.SIZE, height:lib.scaler.sv(140, false), layout:'horizontal' });
    ...
    if (spacer) {
        _spacer = Ti.UI.createView({ touchEnabled:false /* #BUG */, width:lib.scaler.sv(30, true), height:lib.scaler.sv(5, false), right:0, touchEnabled:false });
    ...
    // _metricElement.parentView.addEventListener('touchend', _metricElement.controllers.blurNumber); #BUG
...
function generateMetricElements() {
    ...
    state.size.widthOfMetricContainer = lib.scaler.sv(40, true); // reset
...
function scale() {
    lib.scaler.sp($.parentView, { height:140, width:620 });
    lib.scaler.sp($.metricScrollView, { width:620 });
    lib.scaler.sp($.metricContainer, { width:10000 /* #BUG */, height:140 });
    lib.scaler.sp($.leftShadow, { width:20 });
    lib.scaler.sp($.rightShadow, { width:20 });
}
